...
import doctor from "../../assets/images/HomeImages/doctor.png";
import docTool from "../../assets/images/HomeImages/docTool.png";
const Home = () => {
  const Data = [
    {
      name: "Misbah Khan",
      ...
      img: person1,
      content:
        "It is really good initiative to connect with health care personals. If you feel a need for help then helpline is there to take care of it. overall very good experience.",
      star: 4,
    },
    {
      name: "Maha  Muddasir",
      ...
      img: person2,
      content:
        "My first appointment today.It was a very smooth experience and the skin specialist was very helpful and professional experiences so far facility is also very good.",
      star: 3,
    },
    {
      name: "Aisha Kiran",
  ...
  return (
    <div className={classes.Home}>
      ...
      <h1 className={classes.Title}>
        Connect with Trusted Medical Experts Near You
      </h1>
      <div className={classes.SerachBarContainer}>
        <LocationBar />
        <SearchBar />

        <h1 className={classes.Title1}>Over 200+ Doctors Registered</h1>
      </div>
      <Wrapper>
        <div className={classes.Lowersection}>
          <ScrollAnimation animateIn={"fadeInLeft"} className={classes.left}>
                  ...
                  >
                    <div className={classes.reviewBox}>
                      ...
                      <div
                        ...
                        className={classes.BottomReview}
                      >
