const docData = [
...

    {
        ...
        'services': ['Fracture Treatment', 'Joint Replacement Surgery', 'Arthroscopy', 'Sports Injury Management'],
        'conditionsTreated': ['Sprains', 'Strains', 'Arthritis', 'Tendonitis', 'Fractures'],
        'surgeriesPerformed': ['Knee Replacement Surgery', 'Shoulder Arthroscopy'],
        'professionalMemberships': ['American Academy of Orthopaedic Surgeons (AAOS)', 'American Orthopaedic Society for Sports Medicine (AOSSM)'],
...

    {
        ...
        'services': ['Well-Child Checkups', 'Vaccinations', 'Newborn Care', 'Childhood Illness Management'],
        'conditionsTreated': ['Common Cold', 'Asthma', 'Gastroenteritis', 'Developmental Delays', 'Allergies'],
        'surgeriesPerformed': [],
        'professionalMemberships': ['American Academy of Pediatrics (AAP)'],
        'languagesSpoken': ['English', 'Hindi'],
        'experience': '12 Years',
        'satisfiedPatients': .93,
        'noOfReviews': 62,
        'waitTime': 10,
...

    {
        ...
        'services': ['Cataract Surgery', 'Retinal Detachment Repair', 'Macular Degeneration Treatment', 'Diabetic Eye Care'],
        'conditionsTreated': ['Glaucoma', 'Macular Edema', 'Retinitis Pigmentosa', 'Uveitis', 'Dry Eyes'],
        'surgeriesPerformed': ['Vitrectomy', 'Laser Eye Surgery'],
        'professionalMemberships': ['Royal Australian and New Zealand College of Ophthalmologists (RANZCO)'],
        'languagesSpoken': ['English', 'Korean'],
        'experience': '14 Years',
        'satisfiedPatients': .96,
        'noOfReviews': 105,
        'waitTime': 30,
        'isPlatinumDoctor': true
    },

    {
        ...
        'services': ['Depression Therapy', 'Anxiety Management', 'Cognitive Behavioral Therapy', 'Stress Management'],
        'conditionsTreated': ['Major Depressive Disorder', 'Generalized Anxiety Disorder', 'Bipolar Disorder', 'Post-Traumatic Stress Disorder', 'Obsessive-Compulsive Disorder'],
        'surgeriesPerformed': [],
        'professionalMemberships': ['American Psychiatric Association (APA)', 'Royal College of Psychiatrists (RCPsych)'],
...

    {
        ...
        'conditionsTreated': ['Malocclusion', 'Crooked Teeth', 'Overbite', 'Underbite', 'TMJ Disorders'],
        'surgeriesPerformed': [],
        'professionalMemberships': ['American Association of Orthodontists (AAO)', 'Canadian Association of Orthodontists (CAO)'],
        'languagesSpoken': ['English', 'French'],
        'experience': '13 Years',
        'waitTime': 25,
        'satisfiedPatients': .94,
        'noOfReviews': 88,
        'isPlatinumDoctor': true
...
const FAQData = [
    {
      ...
      answer: "Acne is primarily caused by excess oil production, clogged pores, bacteria, and inflammation. Hormonal changes, certain medications, and genetic factors can also contribute to acne.",
    },
    {
      question: "How can I prevent sunburn?",
      answer: "To prevent sunburn, it is important to apply sunscreen with a high SPF, wear protective clothing, seek shade during peak sun hours, and avoid tanning beds. Reapply sunscreen every two hours and after swimming or sweating.",
    },
    {
      question: "What are the common signs of skin cancer?",
      answer: "Common signs of skin cancer include changes in the appearance of moles or growths, such as asymmetry, irregular borders, color variations, and changes in size or thickness. It is important to consult a dermatologist if you notice any suspicious changes on your skin.",
    },
    {
      question: "How often should I moisturize my skin?",
      answer: "The frequency of moisturizing depends on your skin type. Generally, it is recommended to moisturize your skin twice a day, in the morning and evening. However, if you have dry skin, you may need to moisturize more frequently to keep your skin hydrated.",
    },
];
